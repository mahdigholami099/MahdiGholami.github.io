...
loader.load("../models/tv.glb", function (gltf) {
  ...
  function animate() {
    ...
    try {
      ...
      const topRightColor = getAvrageUsedColor(
        ctx.getImageData(canvas.width / 2, 0, canvas.width, canvas.height)
      );
      const bottomLeftColor = getAvrageUsedColor(
        ctx.getImageData(
          0,
          canvas.height / 2,
          canvas.width / 2,
      ...
      const bottomRightColor = getAvrageUsedColor(
        ctx.getImageData(
          canvas.width / 2,
          canvas.height / 2,
          canvas.width,
